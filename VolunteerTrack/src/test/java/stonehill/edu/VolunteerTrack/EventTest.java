...
public class EventTest {
	...
	public void testGetEmail() {
		Event testEvent = new Event("zac@testing.com", "test event", "this event is for testing","In unit test land",
				"zac unit testing, co", 1, 0,new Date(), new Date(), new Date(), new Skill[0]);
