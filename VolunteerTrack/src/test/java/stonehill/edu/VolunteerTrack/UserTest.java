...
public class UserTest {
	...
	public void testGetEmail() {
		User testUser = new User(-1, "testemail@test.com", "testpass", "first", "last", "street", "city", "state", "zip", "phone", 
				"description", "description", false, false, false, "major", "minor", false, false, false, "orgname", "");
